  ...
  return (
    <header className={`site-header ${scrolled ? "is-scrolled" : ""}`}>
      <div className="container-wide flex h-[76px] items-center justify-between">
        <Link href="/" aria-label="Revplus home" data-cursor="link">
          <Logo />
        </Link>
        <nav
      ...
      <div className={`mobile-menu lg:hidden ${open ? "open" : ""}`}>
        <nav
          className="container-wide flex flex-col py-5"
        ...
        >
          ...
          <a
            href="tel:+18329429484"
            className="mt-5 text-sm font-bold text-cyan"
          >
            +1 832-942-9484
          </a>
        </nav>
